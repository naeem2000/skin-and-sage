...
export default function Moment() {
	return (
		<section className='max-width flex items-center justify-center flex-col relative h-[397px] !mt-20 w-full bg-top bg-cover bg-no-repeat bg-[image:var(--moment-bg)] z-10'>
